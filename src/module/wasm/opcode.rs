...
impl TryInto<Instruction> for Main {
    ...
    fn try_into(self) -> Result<Instruction, Self::Error> {
        Ok(match self {
            ...
            Main::SelectTyped          => Instruction::SelectTyped,
            ...
            Main::I32Load              => Instruction::I32Load,
            Main::I64Load              => Instruction::I64Load,
            Main::F32Load              => Instruction::F32Load,
            Main::F64Load              => Instruction::F64Load,
            ...
            Main::I32Store             => Instruction::I32Store,
            Main::I64Store             => Instruction::I64Store,
            Main::F32Store             => Instruction::F32Store,
            Main::F64Store             => Instruction::F64Store,
            Main::I32Store8            => Instruction::I32Store8,
            Main::I32Store16           => Instruction::I32Store16,
            Main::I64Store8            => Instruction::I64Store8,
            Main::I64Store16           => Instruction::I64Store16,
            Main::I64Store32           => Instruction::I64Store32,
